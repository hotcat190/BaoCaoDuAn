...
Từ những phân tích hiện trạng trên, dự án này định vị mục tiêu phân tách triệt để giữa tầng hiển thị đồ họa nền và tầng hiển thị thông tin văn bản. Thay vì xem một trang truyện tranh là một bức ảnh phẳng bất biến, hệ thống cần số hóa cấu trúc của trang truyện thành một mô hình dữ liệu động gồm hai thành phần tách biệt: ảnh nền sạch dữ liệu chữ và tệp siêu dữ liệu chứa tọa độ cấu trúc khung thoại cùng nội dung dịch của các ngôn ngữ mục tiêu.
